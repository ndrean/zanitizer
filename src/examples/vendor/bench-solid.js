...
var _tmpl$ = /* @__PURE__ */ template(`<div class="col-sm-6 smallpad"><button class="btn btn-primary btn-block"type=button>`);
...
var _tmpl$3 = /* @__PURE__ */ template(`<tr><td class=col-md-1></td><td class=col-md-4><a class=lbl> </a></td><td class=col-md-1><a><span class="remove glyphicon glyphicon-remove"aria-hidden=true></span></a></td><td class=col-md-6>`);
...
var random = (max) => Math.round(Math.random() * 1000) % max;
var nextId = 1;
var buildData = (count) => {
...
var Button = ([id, text, fn]) => (() => {
  var _el$ = _tmpl$(), _el$2 = _el$.firstChild;
  addEventListener(_el$2, "click", fn, true);
  setAttribute(_el$2, "id", id);
  insert(_el$2, text);
  return _el$;
})();
render(() => {
  ...
  const runLots = () => setData(buildData(1e4));
  ...
  return (() => {
    var _el$3 = _tmpl$2(), _el$4 = _el$3.firstChild, _el$5 = _el$4.firstChild, _el$6 = _el$5.firstChild, _el$7 = _el$6.nextSibling, _el$8 = _el$7.firstChild, _el$9 = _el$4.nextSibling, _el$0 = _el$9.firstChild;
    insert(_el$8, createComponent(Button, ["run", "Create 1,000 rows", run]), null);
    insert(_el$8, createComponent(Button, ["runlots", "Create 10,000 rows", runLots]), null);
    insert(_el$8, createComponent(Button, ["add", "Append 1,000 rows", add]), null);
    insert(_el$8, createComponent(Button, ["update", "Update every 10th row", update]), null);
    insert(_el$8, createComponent(Button, ["clear", "Clear", clear]), null);
    insert(_el$8, createComponent(Button, ["swaprows", "Swap Rows", swapRows]), null);
    insert(_el$0, createComponent(For, {
      ...
      children: (row) => {
        let rowId = row.id;
        return (() => {
          var _el$1 = _tmpl$3(), _el$10 = _el$1.firstChild, _el$11 = _el$10.nextSibling, _el$12 = _el$11.firstChild, _el$13 = _el$12.firstChild, _el$14 = _el$11.nextSibling, _el$15 = _el$14.firstChild;
          _el$10.textContent = rowId;
          _el$12.$$click = () => setSelected(rowId);
          _el$15.$$click = () => setData((d) => d.filter((x) => x.id !== rowId));
          createRenderEffect((_p$) => {
            var _v$ = isSelected(rowId) ? "danger" : "", _v$2 = row.label();
