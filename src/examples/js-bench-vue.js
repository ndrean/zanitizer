...
import { buildData } from "js-bench-vue-data.js";
  ...
  <table class="table table-hover table-striped test-data">
    <tbody>
      ...
      >
        ...
        <td class="col-md-4">
          <a class="lbl" @click="select(id)">{{ label }}</a>
        </td>
        <td class="col-md-1">
          <a @click="remove(id)">
...
app.config.errorHandler = (err, instance, info) => {
  if (!err) {
    console.log("[Vue ERROR] null error, info:", info);
    return;
  }
  console.log("[Vue ERROR]", err.message);
