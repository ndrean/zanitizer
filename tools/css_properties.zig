//! CSS Properties for code generation
//! Each tuple: { js_name (camelCase), css_name (kebab-case) }
//!
//! JS accesses as: element.style.backgroundColor
//! CSS property is: background-color

pub const css_properties = .{
    // A
    ...
    .{ "flexWrap", "flex-wrap" },
    .{ "cssFloat", "float" }, // "float" is reserved, use cssFloat
    .{ "font", "font" },
...
// Count for reference: ~370 properties
pub const css_property_count = css_properties.len;
